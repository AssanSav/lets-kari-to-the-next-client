  ...
  return (
    <Navbar className="pb-10 " style={{ backgroundColor: "black" }}>
      {props.status ? (
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              <NavDropdown title="Options" id="collasible-nav-dropdown">
                ...
                <NavDropdown.Item href="/received-messages">
                  Inbox
                </NavDropdown.Item>
                <NavDropdown.Item href="sent-messages">Outbox</NavDropdown.Item>
                <NavDropdown.Divider />
                <NavDropdown.Item href="/login" onClick={(e) => handleClick(e)}>
                  Logout
                </NavDropdown.Item>
              </NavDropdown>
              <Nav.Link href="/sent-messages" className="mb-0">
                Outbox
              </Nav.Link>
        ...
        <>
          <Nav>
            <Navbar.Brand style={{ color: "red", fontStyle: "bold" }}>
              Let's Meetup!
            </Navbar.Brand>
